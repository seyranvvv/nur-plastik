                    ...
                    <div class="col-4 my-3">
                        <div class="card border-left-{!! $count['color'] !!} shadow h-100">
                            <div class="card-body p-3">
                                <div class="h5 font-weight-bold text-{!! $count['color'] !!} text-uppercase">{!! $count['name'] !!}</div>
                                <div class="h3 mb-0 font-weight-bold">{!! $count['count'] !!}</div>
                                <div class="text-right">
                                    <i class="fas fa-{!! $count['icon'] !!} fa-3x text-{!! $count['color'] !!}"></i>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        {{-- <div class="col-md-6 my-3">
             <div class="card shadow">
                 <div class="card-body text-center p-5">
                     <img src="{{ asset('front/ddddd.webp') }}" alt="Ak kent"
                          class="img-fluid my-auto w-50 px-sm-3 px-5">
                     --}}{{--     <div class="h2 font-weight-bold mt-4">Ak kent</div>--}}{{--
                 </div>
             </div>
         </div>--}}
                ...
                <div class="card-header py-3">
                    <div class="h6 mb-0">
                        ...
                        <span class="text-secondary">
                            {!! $maps->sum('count') !!} @lang('transAdmin.visitor')
                        </span>
                    </div>
                </div>
