...
@section('content')
    <div class="d-flex align-items-center justify-content-between">
        <div class="h3 mb-0">@lang('transFront.maksat')</div>
    </div>
    ...
    <table class="table shadow table-bordered table-striped table-hover table-md bg-white mt-4">
        ...
        @forelse($objs as $obj)
            <tr>
                ...
                <td>
                    <a href="{{ route('admin.goal.edit', $obj->id) }}" class="btn btn-outline-success btn-sm mb-1">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-right">
                                    <form action="{{ route('admin.goal.delete', $obj->id) }}" method="post">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
        ...
        @empty
            <tr>
                <td colspan="3" class="text-center bg-light text-secondary">
                    <i class="fas fa-exclamation-circle"></i> @lang('transFront.maksat') @lang('transAdmin.not-found')
                </td>
            </tr>
        @endforelse
        </tbody>
